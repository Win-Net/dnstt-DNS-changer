...
- Ability to choose your desired socks port
- Scan DNS with the ability to add and replace automatically + (Real Test)
- Automatic DNS scanning feature
...
- امکان انتخاب پورت ساکس دلخواه
- اسکن DNS با قابلیت ادد و جایگزین کردن خودکار + (تست واقعی)
- قابلیت اسکن خودکار DNS
